...
def main(model_arch_path:str, model_weights_path:str, output_dir_path:str)->None:
  ...
  # Generating rules.h
  rules_h: str = generate_rules_h(model_arch)
  output_rules_path: str = os.path.join(output_dir_path, "rules.h")
  with open(output_rules_path, 'w') as rules_file:
    rules_file.write(rules_h)


  # Generating weights.h
  weights_h: str = generate_weights_h(weights)
  output_weights_path: str = os.path.join(output_dir_path, "weights.h")
  with open(output_weights_path, 'w') as weights_file:
    weights_file.write(weights_h)


  # Generating net.h
  net_h: str = generate_net_h(model_arch, output_rules_path, output_weights_path)
